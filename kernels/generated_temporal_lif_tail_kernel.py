...
@triton.jit
def _temporal_lif_tail_linear_kernel(
    pooled,
    fc_weight,
    fc_bias,
    out_sum,
...
@triton.jit
def _temporal_lif_tail_linear_kernel_nobias(
    pooled,
    fc_weight,
    out_sum,
    n_classes: tl.constexpr,
...
def run_fused_temporal_lif_tail_kernel(
    x_seq: torch.Tensor,
    v_init: torch.Tensor,
    ...
    if fc_bias is not None and fc_bias.numel() > 0:
        _temporal_lif_tail_linear_kernel[grid](
            pooled,
            fc_weight,
            fc_bias,
            out_sum,
        ...
        _temporal_lif_tail_linear_kernel_nobias[grid](
            pooled,
            fc_weight,
            out_sum,
            classes,
